...
const routes = {
  "/": (_,res)=> ok(res, "SmartFlowSite ✓ (emergency online)"),
  "/api/health": (_,res)=> ok(res, JSON.stringify({ok:true, service:"SmartFlowSite", via:"emergency", ts:Date.now()}),"application/json"),
  "/api/gh-sync": (req,res)=>{
