...
async function setupLeadForm() {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        // Safe DOM manipulation instead of // XSS FIX: removed innerHTML with user data
